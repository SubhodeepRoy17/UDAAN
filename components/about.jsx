          ...
          <div className="flex items-center justify-between h-18">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className={`text-xs font-medium ${isScrolled ? "text-blue-100" : "text-blue-100"}`}>IIC-HITK</p>
              </div>
            </div>
              ...
              {navigationItems.map((item) => (
                ...
                >
                  <button
                    ...
                    className={`px-3 py-2 rounded-full text-sm font-medium transition-all duration-300 hover:scale-105 flex items-center ${
                  ...
                  >
                    {item.name}
                    {item.dropdown && (
                      <ChevronDown className={`w-4 h-4 ml-1 transition-transform ${isAboutHovered ? 'rotate-180' : ''}`} />
                    )}
                  </button>
            ...
            <div className="hidden lg:flex items-center gap-2">
              <Button
                ...
                variant="outline"
                size="sm"
                className="rounded-full font-semibold transition-all duration-300 hover:scale-105 text-xs px-3 py-1 border-white text-white hover:bg-white hover:text-blue-700 bg-transparent"
              >
              ...
              <Button
                onClick={() => scrollToSection("#registration")}
                size="sm"
                className="rounded-full font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 group text-xs px-3 py-1 bg-gradient-to-r from-orange-500 to-blue-500 hover:from-orange-600 hover:to-blue-600 text-white"
              >
                Register Now
